<div class="modal fade" id="slack-channel-seatGroupMissingRefreshToken-modal" style="text-align: left">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="subscribeToseatGroupMissingRefreshTokenSlack" role="form"
          ...
          <div class="form-group">
            ...
            <select name="channel_id" id="available_channels" class="form-control" style="width: 100%"
                    form="subscribeToseatGroupMissingRefreshTokenSlack">
              <option></option>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" form="subscribeToseatGroupMissingRefreshTokenSlack" class="btn btn-primary">Save changes</button>
      </div>
