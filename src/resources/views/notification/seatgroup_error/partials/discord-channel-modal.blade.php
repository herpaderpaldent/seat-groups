<div class="modal fade" id="discord-channel-seatGroupError-modal" style="text-align: left">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span></button>
        <h4 class="modal-title">Subscribe to SeAT Group Error Notifications (Discord)</h4>
      </div>
      <div class="modal-body">

        <form id="subscribeToseatGroupErrorDiscord" role="form"
          ...
          <div class="form-group">
            ...
            <select name="channel_id" id="available_channels" class="form-control" style="width: 100%"
                    form="subscribeToseatGroupErrorDiscord">
              <option></option>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" form="subscribeToseatGroupErrorDiscord" class="btn btn-primary">Save
          changes
        </button>
      </div>
