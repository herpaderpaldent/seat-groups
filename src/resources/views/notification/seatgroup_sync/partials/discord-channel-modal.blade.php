<div class="modal fade" id="discord-channel-seatGroupSync-modal" style="text-align: left">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="subscribeToseatGroupSyncDiscord" role="form"
          ...
          <div class="form-group">
            ...
            <select name="channel_id" id="available_channels" class="form-control" style="width: 100%"
                    form="subscribeToseatGroupSyncDiscord">
              <option></option>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" form="subscribeToseatGroupSyncDiscord" class="btn btn-primary">Save
          changes
        </button>
      </div>
